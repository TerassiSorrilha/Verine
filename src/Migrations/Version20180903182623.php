 ...
 */
class Version20180903182623 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE todocartoes ADD is_active BIT NOT NULL DEFAULT 0');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE todocartoes DROP COLUMN is_active');
        $this->addSql('ALTER TABLE todocartoes ALTER COLUMN posicao INT NOT NULL');
